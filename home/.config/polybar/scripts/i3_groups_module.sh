...
# Adapted from i3-groups
# Issue: https://github.com/infokiller/i3-workspace-groups/issues/39
# Most recent pushed PR: https://github.com/infokiller/i3-workspace-groups/pull/42
